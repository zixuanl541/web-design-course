<html>
    ...
    <body>
        ...
        <form action="submit.php" method="post">
            ...
            Name: 
            <input type="text" placeholder="Enter camper's full name" name="camper_name" value=""><br><br>
            ...
            Age:
            <input type="number" id="age" name="age" min="6" max="12"><br><br>
            ...
            Name:
            <input type="text" name="parent_name"><br><br>
            Phone Number:
            ...
            <input type="tel" id="emergency_phone" name="emergency_phone"><br><br>
